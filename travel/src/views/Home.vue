<template>
  ...
  <v-main>
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <v-row>
            <v-col cols="12" sm="6">
              <h1 class="title1">
                <span class="title1__span">Travel</span> with us <br />
                <span class="title1__span">Enjoy</span> your life
              </h1>
              <p class="par1">
                Lorem ipsum dolor sit amet consectetur.<br />
                Quisquam voluptatum, quibusdam, voluptate,<br />
              ...
              <v-btn
                class="text-none ml-2 text-indigo-lighten-1 mt-8"
                size="x-large"
                variant="flat"
                rounded="0"
              >
            ...
            <v-col cols="12" sm="6">
              <v-img class="img1" src="/3.jpg"></v-img>
            </v-col>
          </v-row>
        </v-col>
        <v-col cols="12" sm="12">
            ...
            <v-window v-model="tab">
              <v-window-item v-for="n in 4" :key="n" :value="n">
                <v-container fluid>
                  <v-row>
                    <v-col cols="12" sm="2">
                      <div class="text-subtile-1 text-medium-emphasis">
                        Your Destination
                      </div>
                      <v-select
                        density="compact"
        ...
        <v-col cols="12" sm="12">
          ...
          <h1 class="text-center">Beautiful Places Around The World</h1>
            ...
            <v-col cols="12" sm="10">
                ...
                <v-col cols="12" sm="4">
                  <v-hover v-slot="{ isHovering, props }">
                    ...
                    >
                      ...
                      <div>
                        <p class="ma-0 text-body-1 font-weight-bold">Starting From $1500</p>
                      </div>
                    </div>
              ...
              <v-col cols="4" class="d-flex flex-column">
                <v-row>
                  ...
                  <v-img src="/6.png" cover height="100%">
                  ...
                  <v-col cols="12" sm="12">
                    <v-hover v-slot="{ isHovering, props}">
                  <v-card :elevation="isHovering ? 12: 2" :class="{ 'on-hover':isHovering }" v-bind="props" class="card1">
                  <v-img src="/7.png" cover height="100%">
                    <div class="d-flex flex-row-reverse">
                      <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat" rounded="0" elevation="12">
                        4 Packages
                      </v-btn>
              ...
              <v-col cols="12" sm="4">
                <v-hover v-slot="{ isHovering, props}">
                  <v-card :elevation="isHovering ? 12: 2" :class="{ 'on-hover':isHovering }" v-bind="props" class="card1">
                  <v-img src="/8.png" cover height="100%">
                    <div class="d-flex flex-row-reverse">
                      <v-btn class="text-none mr-2 mt-2" color="indigo-lighten-1" size="x-large" variant="flat" rounded="0" elevation="12">
                        5 Packages
                      </v-btn>
      ...
      <v-col cols="12" sm="12">
        <h4 class="text-center text-indigo-lighten-1">Popular Package</h4>
        ...
        <v-card>
          <v-img src="/p.jpg" cover height="100%">
            <div class="d-flex justify-center ligne1">
              <h1 class="text-white text-h3 mb-5">Sign up for our newsletter</h1>
            </div>
...
.indigo-lighten-1 {
  background-color: #165ea5 !important;
}
</style>